        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (!(a && a.length && (e = a.data("bs.collapse"), e && e.transitioning))) {
                ...
                if (this.$element.trigger(o), !o.isDefaultPrevented()) {
                    ...
                    this.$element.one("bsTransitionEnd", t.proxy(s, this)).emulateTransitionEnd(i.TRANSITION_DURATION)[r](this.$element[0][d])
                }
            }
        }
...
if ($.browser.mobile === false && navigator.userAgent.match(/Mac/) && navigator.maxTouchPoints && navigator.maxTouchPoints > 2) {
    $.browser.mobile = true;
};
var WEB_URL = '../../index.html';
var original_content;
var matchMedia_support = false;
if (typeof window.matchMedia !== 'undefined' && typeof window.matchMedia === 'function') {
    matchMedia_support = true;
}
...
function quick_search(str) {
    $.get("../../ajax.html", {
        ...
        $('.list-search-res').html(data);
    });
}

function load_comment(id, truyencomment, fbcolor) {
    fbcolor = 'light';
    $('#' + id).prepend('<div class="fb-comments" data-href="https://trumtruyen.com/' + truyencomment + '/" data-width="100%" width="100%" data-numposts="5" data-colorscheme="' + fbcolor + '"></div>');
    if (typeof FB !== 'undefined') FB.XFBML.parse(document.getElementById(id));
    else {
...
function update_views(truyenid, pagetype) {
    $.post("../../ajax.html", {
        type: "update_views",
        tid: truyenid,
        add: pagetype,
...
$(document).ready(function () {
    ...
    if (typeof window.matchMedia === "function") {
        if ($.browser.mobile && window.matchMedia("only screen and (min-width: 600px)").matches) window.mobile_tablet = true;
    }
    window.truyen_ascii = $("#truyen-ascii").val();
    window.truyenid = $("#truyen-id").val();
    window.bgcolor = $.cookie('bgcolor-cookie');
    window.fbcolor = 'light';
    if (bgcolor == "#232323") {
        fbcolor = 'dark';
        if ($('#truyen-background').length) $('#truyen-background');
    }
    if (bgcolor) {
        $('#truyen-background').val(bgcolor);
    }
    $(".moon-toggle").each(function () {
        if ($(this).css("display") !== "none") {
            $(this).attr("style", "display:inline-block");
            $(this).click(function () {
                if ($(this).attr('class').indexOf("moon-toggle-dark") > -1) {
                    $(this).html('<path d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278zM4.858 1.311A7.269 7.269 0 0 0 1.025 7.71c0 4.02 3.279 7.276 7.319 7.276a7.316 7.316 0 0 0 5.205-2.162c-.337.042-.68.063-1.029.063-4.61 0-8.343-3.714-8.343-8.29 0-1.167.242-2.278.681-3.286z"/>');
                    $(this).attr("class", "moon-toggle");
                } else {
                    $(this).html('<path d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278z"/>');
                    $(this).attr("class", "moon-toggle moon-toggle-dark");
                }
                var bgcolor = $.cookie('bgcolor-cookie');
                if (bgcolor != "#232323") {
                    if (bgcolor && bgcolor != '#232323') $.cookie('bgcolor-backup-cookie', bgcolor, {
                        expires: 365,
                        path: '/'
                    });
                    bgcolor = '#232323';
                    ...
                    if ($('#truyen-background').length) {
                        $('#truyen-background').val(bgcolor);
                        var contrast_dark = $.cookie('contrast-dark-cookie');
                        if (contrast_dark) $(".chapter-c").css("color", "rgba(165,165,165," + contrast_dark + ")");
                        else $(".chapter-c").css("color", "rgba(165,165,165,1)");
                        $('#contrast-chu').val(contrast_dark);
                    }
                } else {
                    var bgcolor_backup = $.cookie('bgcolor-backup-cookie');
                    if (bgcolor_backup) bgcolor = bgcolor_backup;
                    else bgcolor = '#F4F4F4';
                    if ($('#truyen-background').length) {
                        var contrast = $.cookie('contrast-cookie');
                        if (contrast) $(".chapter-c").css("color", "rgba(43,43,43," + contrast + ")");
                        else $(".chapter-c").css("color", "rgba(43,43,43,1)");
                        $('#contrast-chu').val(contrast);
                        $('#truyen-background').val(bgcolor);
                        if (bgcolor == 'hatsan') {
                            $("body").css({
                        ...
                        $("body").css({
                            ...
                            "background-image": "url('//static.trumtruyen.vip/img/bg.jpg')",
    ...
    $('#search-input').keyup(function () {
        ...
        if (str.length == 0) {
            ...
            $('.list-search-res').html('<img src="//static.trumtruyen.vip/img/loading-search.gif" alt="loading">').removeClass("hide");
...
if (matchMedia_support) {
    var max_480 = window.matchMedia('(max-width: 480px)').matches;
    var min_1025 = window.matchMedia('(min-width: 1025px)').matches;
}
$(document).ready(function () {
    var tentruyen = $("#ten-truyen").val();
    var fb_loaded = 0;
    var truyencomment;
    $(window).scroll(function () {
        if (truyenid && fb_loaded == 0) {
            (function (d, s, id) {
                var js, fjs = d.getElementsByTagName(s)[0];
                if (d.getElementById(id)) return;
                js = d.createElement(s);
                js.id = id;
                js.src = '../../../connect.facebook.net/vi_VN/all.js#version=v3.1&appId=694317543935094';
                fjs.parentNode.insertBefore(js, fjs);
            }(document, 'script', 'facebook-jssdk'));
            truyencomment = $("#truyen-comment").val();
            fb_loaded = 1;
        }
    });
    if (tentruyen) {
        console.log('document ready!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
        var font = $.cookie('font-cookie');
        var size = $.cookie('size-cookie');
        var contrast = $.cookie('contrast-cookie');
        var contrast_dark = $.cookie('contrast-dark-cookie');
        var lineheight = $.cookie('lineheight-cookie');
        var fluid_switch = $.cookie('fluid-switch-cookie');
        var onebreak_switch = $.cookie('onebreak-switch-cookie');
        var chapterbnum = $("#chapter-bnum").val();
        var chapternum = $("#chapter-num").val();
        ...
        if (font) {
            ...
            if (matchMedia_support) {
                if (max_480) {
                    ...
                    $('#font-chu').val("'Palatino Linotype', serif");
                }
            } else {
                if ($.browser.mobile) {
                    $('#font-chu').val("Arial, sans-serif");
        ...
        if (contrast && bgcolor != '#232323') {
            $('#contrast-chu').val(contrast);
        } else if (contrast_dark && bgcolor == '#232323') {
            $('#contrast-chu').val(contrast_dark);
        }
        $('#font-chu').on('change', function () {
            var font = this.value;
            $(".chapter-c").css("font-family", font);
            $.cookie('font-cookie', font, {
                expires: 365,
                path: '/'
            });
        });
        ...
        $('#contrast-chu').on('change', function () {
            var contrast_chosen = this.value;
            var bgcolor = $.cookie('bgcolor-cookie');
            if (bgcolor != '#232323') {
                $.cookie('contrast-cookie', contrast_chosen, {
                    expires: 365,
                    path: '/'
                });
                $(".chapter-c").css("color", "rgba(43,43,43," + contrast_chosen + ")");
            } else {
                $.cookie('contrast-dark-cookie', contrast_chosen, {
                    expires: 365,
                    path: '/'
                });
                $(".chapter-c").css("color", "rgba(165,165,165," + contrast_chosen + ")");
            }
        });
        $('#line-height').on('change', function () {
            var lineheight = this.value;
            $(".chapter-c").css("line-height", lineheight);
            $.cookie('lineheight-cookie', lineheight, {
                expires: 365,
                path: '/'
            });
        });
        ...
        $(document.body).on('click', '.chapter .toggle-nav-open', function () {
            var hidenav = $.cookie("hidenav-cookie");
            if (hidenav == 1) {
        ...
        $(document.body).on('click', '.chapter .toggle-settings-open', function (e) {
            event.stopPropagation();
            if ($('.settings').hasClass("hide") == true) {
                $(".settings").removeClass("hide").animate({
                    bottom: '0'
                }, 400);
            } else {
                $(".settings").animate({
        ...
        $(document.body).on('click', '.settings .close', function (e) {
            event.stopPropagation();
            $(".settings").animate({
                bottom: '-300px'
            }, 400, function () {
        ...
        $('input[name="onebreak-switch"]').click(function () {
            var answer = this.value;
            if (answer == 'yes') {
                $('.chapter-c').html($('.chapter-c').html().replace(/(<br\s*\/?>\s*\n?(&nbsp;)?){2,}/gi, '<br>'));
                ...
                if (original_content) {
                    $('.chapter-c').html(original_content);
                }
        ...
        $(document).keydown(function (e) {
            if ($("input[type='text'], input[type='search']").is(":focus") === false && !e.ctrlKey) {
        ...
        $(".chapter-nav").on('click', 'button.chapter_jump', function () {
            ...
            $.get("../../ajax.html", {
                ...
                var insert_bnum = '';
                if (chapterbnum) insert_bnum = 'quyen-' + chapterbnum + '-';
                var current_url = insert_bnum + 'chuong-' + chapternum + '">';
                var current_selected = insert_bnum + 'chuong-' + chapternum + '" selected>';
                var url_re = new RegExp(current_url, "g");
                data = data.replace(url_re, current_selected);
                $('.chapter_jump').replaceWith(data);
            });
        });
        ...
        $(".chapter-nav").on('click', 'button#chapter_comment', function () {
            $('#fb-comment-chapter').html('<div class="loading-comment"><div></div><div></div><div></div></div>');
            load_comment('fb-comment-chapter', truyencomment, fbcolor);
        });
        var tenfull = $('.truyen-title').text();
        $.post("../../ajax.html", {
        ...
        if ($('.chapter-c').text() === "*Chương này có nội dung ảnh, nếu bạn không thấy nội dung chương, vui lòng bật chế độ hiện hình ảnh của trình duyệt để đọc.") {
    ...
    $('#chapter-nav-top, #chapter-nav-bot').on('change', '.chapter_jump', function () {
        ...
        if (valueSelected && tentruyen) window.location.href = WEB_URL + "/" + tentruyen + "/" + valueSelected + "/";
    });
    gtag('event', 'chapter_views');
    if (chaptersac == 1) gtag('event', 'chapter_views_sac');
});;
! function (t, e) {
...
function rotate_cookie_func(rorate_pos, min, max) {
    ...
    var rotate_val;
    if (rotate_cookie) rotate_val = rotate_cookie;
    else rotate_val = randomso(min, max);
    if (rotate_val >= max) $.cookie(rorate_pos, min, {
        expires: 1,
        path: '/'
    });
    else $.cookie(rorate_pos, (Number(rotate_val) + 1), {
        expires: 1,
        path: '/'
    });
    return rotate_val;
...
function ads_load() { }
$(document).ready(function () {
    var WEB_URL = 'https://trumtruyen.me/';
    var tentruyen = $("#ten-truyen").val();
    var truyenascii = $("#truyen-ascii").val();
    if (tentruyen) {
        if ($.browser.mobile) {
            ads_load();
        } else { }
...
ga.async = true;
ga.src = '../../../static.trumtruyen.vip/js/analytics_GA4.js';
